...
for evidence-driven debugging, feature delivery, and project-harness
bootstrapping across Codex, Claude Code, and Cursor. The public repository is
available for developing or auditing the harness.
